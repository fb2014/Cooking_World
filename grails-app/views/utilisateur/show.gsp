...
<div id="show-utilisateur" class="content scaffold-show" role="main">
    ...
    <ol class="property-list utilisateur">
        ...
        <g:if test="${utilisateurInstance?.coupDeCoeur}">
            <li class="fieldcontain">
                <span id="coupDeCoeur-label" class="property-label"><g:message code="utilisateur.coupDeCoeur.label"
        ...
        <g:if test="${utilisateurInstance?.notes}">
            <li class="fieldcontain">
                <span id="notes-label" class="property-label"><g:message code="utilisateur.notes.label"
                                                                         default="Notes"/></span>
        ...
        <g:if test="${utilisateurInstance?.recette}">
            <li class="fieldcontain">
                <span id="recette-label" class="property-label"><g:message code="utilisateur.recette.label"
                                                                           default="Recette"/></span>
